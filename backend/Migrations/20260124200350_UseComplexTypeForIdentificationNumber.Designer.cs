...
namespace PatientSyncHealth.Migrations
{
    ...
    [Migration("20260124200350_UseComplexTypeForIdentificationNumber")]
    partial class UseComplexTypeForIdentificationNumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PatientSyncHealth.Domain.Aggregates.Patient.Patient", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "IdentificationNumberData", "PatientSyncHealth.Domain.Aggregates.Patient.Patient.IdentificationNumberData#IdentificationNumberData", b1 =>
                        {
                            b1.IsRequired();
